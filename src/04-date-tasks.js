...
function timeSpanToString(startDate, endDate) {
  ...
  return `${formatDateTime(hours)}:${formatDateTime(minutes)}:${formatDateTime(seconds)}.${millisecFormat(milliseconds)}`;
}
